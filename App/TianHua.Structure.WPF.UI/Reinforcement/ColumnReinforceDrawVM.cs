...
{
    public class ColumnReinforceDrawVM
    {
        public ObservableCollection<ColumnExtractInfo> Columns { get; set; }
        public ColumnReinforceDrawModel DrawModel { get; set; }
        ...
        {
            DrawModel = new ColumnReinforceDrawModel();
            DwgSources = new ObservableCollection<string>(ThColumnReinforceDrawConfig.Instance.DwgSources);
            SortWays = new ObservableCollection<string>(ThColumnReinforceDrawConfig.Instance.SortWays);
            LeaderTypes = new ObservableCollection<string>(ThColumnReinforceDrawConfig.Instance.LeaderTypes);
            MarkPositions = new ObservableCollection<string>(ThColumnReinforceDrawConfig.Instance.MarkPositions);
            Columns = new ObservableCollection<ColumnExtractInfo>();
            AddTestDatas();
            ...
            GroupResults = new List<List<ColumnExtractInfo>>();
        }
        ...
        private ColumnExtractInfo Create()
        {
            return new ColumnExtractInfo()
            {
                Number = "AAA",
                Spec = "400x200",
                Uc = 1.02,
