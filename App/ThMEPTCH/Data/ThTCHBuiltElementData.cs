  ...
  static ThTCHBuiltElementDataReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          ...
          "cHJvdG8aE1RoVENIR2VvbWV0cnkucHJvdG8ilQIKFVRoVENIQnVpbHRFbGVt",
          "ZW50RGF0YRIcCgRyb290GAEgASgLMg4uVGhUQ0hSb290RGF0YRIOCgZsZW5n",
          "dGgYAiABKAESDQoFd2lkdGgYAyABKAESDgoGaGVpZ2h0GAQgASgBEhAKCHpf",
          "b2Zmc2V0GAUgASgBEh0KBm9yaWdpbhgGIAEoCzINLlRoVENIUG9pbnQzZBIg",
          "Cgh4X3ZlY3RvchgHIAEoCzIOLlRoVENIVmVjdG9yM2QSKgoSZXh0cnVkZWRf",
          "ZGlyZWN0aW9uGAggASgLMg4uVGhUQ0hWZWN0b3IzZBIkCgdvdXRsaW5lGAkg",
          "ASgLMg4uVGhUQ0hQb2x5bGluZUgAiAEBQgoKCF9vdXRsaW5lYgZwcm90bzM="));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        ...
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::ThTCHBuiltElementData), global::ThTCHBuiltElementData.Parser, new[]{ "Root", "Length", "Width", "Height", "ZOffset", "Origin", "XVector", "ExtrudedDirection", "Outline" }, new[]{ "Outline" }, null, null, null)
        }));
  }
  #endregion
...
#endif
{
  ...
  public ThTCHBuiltElementData(ThTCHBuiltElementData other) : this() {
    ...
    extrudedDirection_ = other.extrudedDirection_ != null ? other.extrudedDirection_.Clone() : null;
  ...
  /// <summary>Field number for the "z_offset" field.</summary>
  public const int ZOffsetFieldNumber = 5;
  private double zOffset_;
  /// <summary>
  /// geometry location 
  /// </summary>
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  ...
  public const int XVectorFieldNumber = 7;
  ...
  /// <summary>Field number for the "extruded_direction" field.</summary>
  public const int ExtrudedDirectionFieldNumber = 8;
  private global::ThTCHVector3d extrudedDirection_;
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
  public global::ThTCHVector3d ExtrudedDirection {
    get { return extrudedDirection_; }
    set {
      extrudedDirection_ = value;
    }
  }

  /// <summary>Field number for the "outline" field.</summary>
  public const int OutlineFieldNumber = 9;
  ...
  public bool Equals(ThTCHBuiltElementData other) {
    ...
    if (!pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.Equals(ZOffset, other.ZOffset)) return false;
    if (!object.Equals(Origin, other.Origin)) return false;
    if (!object.Equals(XVector, other.XVector)) return false;
    if (!object.Equals(ExtrudedDirection, other.ExtrudedDirection)) return false;
  ...
  public override int GetHashCode() {
    ...
    if (ZOffset != 0D) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(ZOffset);
    if (origin_ != null) hash ^= Origin.GetHashCode();
    if (xVector_ != null) hash ^= XVector.GetHashCode();
    if (extrudedDirection_ != null) hash ^= ExtrudedDirection.GetHashCode();
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    if (extrudedDirection_ != null) {
      output.WriteRawTag(66);
      output.WriteMessage(ExtrudedDirection);
    }
    if (outline_ != null) {
  ...
  public int CalculateSize() {
    ...
    if (extrudedDirection_ != null) {
      size += 1 + pb::CodedOutputStream.ComputeMessageSize(ExtrudedDirection);
    }
    if (outline_ != null) {
  ...
  public void MergeFrom(ThTCHBuiltElementData other) {
    ...
    if (other.extrudedDirection_ != null) {
      if (extrudedDirection_ == null) {
        ExtrudedDirection = new global::ThTCHVector3d();
      }
      ExtrudedDirection.MergeFrom(other.ExtrudedDirection);
    }
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 66: {
          ...
          input.ReadMessage(ExtrudedDirection);
          break;
        }
        case 74: {
          if (outline_ == null) {
