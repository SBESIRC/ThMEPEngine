...
{
    public class ThTCHAxisGridDimensionExtractionVisitor : ThDistributionElementExtractionVisitor
    {
        public const string CategoryValue = "轴网标注";
        public ThTCHAxisGridDimensionExtractionVisitor()
        {
        }
