...
namespace ThMEPTCH.CAD
{
    ...
    /// 墙洞
    /// </summary>
    public class THDBHoleExtractionVisitor : ThBuildingElementExtractionVisitor
    {
        ...
        {
            var svr = new HolePropertyService();
            var prop = svr.GetProperty(e.ObjectId);
            return new FloorCurveEntity(GetUniqueId(e, matrix, uid), GetOutline(e, matrix), "墙洞", prop);
        }
