...
namespace ThMEPEngineCore.AreaLayout.CenterLineLayout.Utils
{
    public static class PointsDealer
    {
        ...
        /// </summary>
        /// <param name="uncoverArea"></param>
        /// <param name="dis">离散距离</param>
        /// <param name="ptsInObb"></param>
        /// <returns></returns>
        public static List<Point3d> PointsInUncoverArea(MPolygon uncoverArea, double dis, out List<Point3d> ptsInObb)
        {
