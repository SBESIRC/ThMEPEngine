...
using ThMEPEngineCore.Utils;

namespace ThMEPEngineCore.Bussiness
{
    public class LayoutDemo
    {
        ...
        public List<List<SprayLayoutData>> LayoutSpray(Polyline polyline, List<Polyline> colums)
        {
            ...
            return CreateSprayModels(sresPts, tDir, vDir); ;
        }
        ...
        public void CreatePolyline(Polyline pline, Point3dCollection pts)
        {
