...
namespace ThMEPEngineCore.Progress
{
    ...
    /// </summary>
    public class ThMEPProgressMeter
    {
        #region Fields
        ...
        public ThMEPProgressMeter(IProgressHandler progressHandler)
        ...
        public ThMEPProgressMeter(IProgressHandler progressHandler, string baseMessage)
        ...
        public ThMEPProgressMeter(IProgressHandler progressHandler, string baseMessage, object endValue)
        {
