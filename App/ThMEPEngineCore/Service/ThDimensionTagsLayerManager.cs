...
{
  public  class ThDimensionTagsLayerManager 
    {
        ...
        private static bool IsDimensionTagsLayerName(string name)
        {
            ...
            {
                return ((patterns[0] == "W") && (patterns[1] == "FRPT") && (patterns[2] == "HYDT") && (patterns[3] == "NOTE"));

            }
            else
            {
                return ((patterns[0] == "W") && (patterns[1] == "RAIN") && (patterns[2] == "NOTE")) || ((patterns[0] == "W") && (patterns[1] == "DRAI") && (patterns[2] == "NOTE")) ||
                   ((patterns[0] == "W") && (patterns[1] == "WSUP") && (patterns[2] == "NOTE"));
            }
        }
    }
}
