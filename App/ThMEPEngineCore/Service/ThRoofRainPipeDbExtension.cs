...
{
    public class ThRoofRainPipeDbExtension : ThDbExtension, IDisposable
    {
        public List<Entity> RainPipes { get; set; }
        public ThRoofRainPipeDbExtension(Database db) : base(db)
        {
            LayerFilter = ThRoofRainPipeLayerManager.XrefLayers(db);
