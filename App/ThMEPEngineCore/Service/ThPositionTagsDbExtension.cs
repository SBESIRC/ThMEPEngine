...
{
   public class ThPositionTagsDbExtension : ThDbExtension, IDisposable
    {
        public List<DBText> texts { get; set; }
        public List<Curve> Polylines { get; set; }
        public ThPositionTagsDbExtension(Database db) : base(db)
        {
            LayerFilter = ThPositionTagsLayerManager.XrefLayers(db);
