...
{
    public class ThOriginMarkingcs
    {
        /// <summary>
        /// 上部左支座钢筋
        /// </summary>
        public string UpLeftSteel { get; set; }

        /// <summary>
        /// 上部右支座钢筋
        /// </summary>
        public string UpRightSteel { get; set; }
        ...
        /// 梁上部通长筋或架立筋
        /// </summary>
        public string UpErectingBar { get; set; }

        /// <summary>
        /// 梁下部通长筋或架立筋
        /// </summary>
        public string DownErectingBar { get; set; }
