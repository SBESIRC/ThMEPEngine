...
{
    public class ThIfcCategoryManager
    {
        public readonly static string BeamCategory = "IfcBeam";
        public readonly static string ColumnCategory = "IfcColumn";
        public readonly static string DoorCategory = "IfcDoor";
        public readonly static string RailingCategory = "IfcRailing";
        public readonly static string SlabCategory = "IfcSlab";
