...
namespace ThParkingStall.Core.ObliqueMPartitionLayout.OPostProcess
{
    ...
    {
        public void ORemoveInvalidPillars(ref List<Polygon> pillars, List<InfoCar> cars)
        {
        ...
        public void OCheckLayoutDirectionInfoBeforePostProcessEndLanes(ref List<InfoCar> cars)
        {
