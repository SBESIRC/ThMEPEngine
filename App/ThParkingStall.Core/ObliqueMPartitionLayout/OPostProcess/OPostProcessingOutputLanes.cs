...
namespace ThParkingStall.Core.ObliqueMPartitionLayout.OPostProcess
{
    ...
    {
        public void PostProcessLanes(ref List<LineSegment> lanes, List<Polygon> cars, List<Polygon> inipillars, List<Coordinate> obsvertice)
        {
        ...
        public void ORemoveDuplicatedAndInvalidLanes(ref List<LineSegment> lanes)
        {
        ...
        private void GetConnectedRelationship(List<LineSegment> lanes, ref List<int> Sindexes, ref List<int> Eindexes)
        {
        ...
        private void RelocateLanes(ref List<LineSegment> lanes, List<Coordinate> obsvertice, List<int> Sindexes, List<int> Eindexes)
        {
            //重定位
            double dis = 5000;
        ...
        private void RemoveInvalidPartsOfEndLanes(ref List<LineSegment> lanes, List<Polygon> cars, List<int> Sindexes, List<int> Eindexes)
        {
            double dis = 5000;
