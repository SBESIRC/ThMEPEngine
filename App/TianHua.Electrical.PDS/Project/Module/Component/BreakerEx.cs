...
namespace TianHua.Electrical.PDS.Project.Module.Component.Extension
{
    ...
    /// </summary>
    [CascadeComponent]
    public class BreakerEx : PDSBaseComponent
    {
        /// <summary>
        /// 断路器
        /// </summary>
        ...
        public BreakerEx(double calculateCurrent, List<string> tripDevice, string polesNum, string characteristics, bool isDomesticWaterPump , bool hasLeakageProtection)
        {
        ...
        public BreakerEx(string breakerConfig)
        {
            ComponentType = ComponentType.CB;
