...
namespace TianHua.Electrical.PDS.Project.Module
{
    ...
    public class THPDSProjectSubstation
    {
        ...
        {
            Transformers = new List<THPDSProjectTransformer>();
        }
        ...
        /// 变压器
        /// </summary>
        public List<THPDSProjectTransformer> Transformers { get; set; }
    }

    /// <summary>
    /// 变压器
    /// </summary>
    public class THPDSProjectTransformer
    {
        public THPDSProjectTransformer()
        {
