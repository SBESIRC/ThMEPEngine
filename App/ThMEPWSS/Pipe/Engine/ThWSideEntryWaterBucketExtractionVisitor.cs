...
{
   public class ThWSideEntryWaterBucketExtractionVisitor : ThDistributionElementExtractionVisitor
    {
        ...
        public override bool IsDistributionElement(Entity entity)
        {
            if (entity is BlockReference blkref)
            {
                ...
                return (ThSideEntryWaterBucketLayerManager.IsSideEntryWaterBucketBlockName(name));
            }
            return false;
        }
