    ...
    public class ThWRoofFloorOutPutEngine
    {
        public static void LayoutRoofFloor(ThWCompositeFloorRecognitionEngine FloorEngines, ThWRoofDeviceParameters parameters2, ThWRoofParameters parameters1, AcadDatabase acadDatabase,int scaleFactor,string W_RAIN_NOTE1)
        {
            foreach (var composite in FloorEngines.RoofFloors)
            {
                ...
                ThWPipeOutputFunction.GetCreateLines1(parameters1.engine1.GravityWaterBucketCenter, parameters1.engine1.GravityWaterBucketTag, W_RAIN_NOTE1).ForEach(o => parameters1.roofEntity.Add(o));
                ThWPipeOutputFunction.GetCreateLines1(parameters1.engine1.SideWaterBucketCenter, parameters1.engine1.SideWaterBucketTag, W_RAIN_NOTE1).ForEach(o => parameters1.roofEntity.Add(o));
