    ...
    public class ThWLayoutRoofDeviceFloorEngine
    {
        public static void LayoutRoofDeviceFloor(ThWCompositeFloorRecognitionEngine FloorEngines, ThWRoofDeviceParameters parameters2, AcadDatabase acadDatabase)
        {
            foreach (var composite in FloorEngines.RoofDeviceFloors)
            {
                ...
                ThWPipeOutputFunction.GetListText(parameters2.engine.GravityWaterBucketCenter, parameters2.engine.GravityWaterBucketTag, "DN100").ForEach(o => acadDatabase.ModelSpace.Add(o));
                ThWPipeOutputFunction.GetListText(parameters2.engine.SideWaterBucketCenter, parameters2.engine.SideWaterBucketTag, "DN75").ForEach(o => acadDatabase.ModelSpace.Add(o));
                ThWPipeOutputFunction.GetListText1(parameters2.engine.GravityWaterBucketCenter, parameters2.engine.GravityWaterBucketTag, "重力型雨水斗").ForEach(o => acadDatabase.ModelSpace.Add(o));
                ThWPipeOutputFunction.GetListText1(parameters2.engine.SideWaterBucketCenter, parameters2.engine.SideWaterBucketTag, "侧入式雨水斗").ForEach(o => acadDatabase.ModelSpace.Add(o));
