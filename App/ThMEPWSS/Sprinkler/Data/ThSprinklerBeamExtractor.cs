...
{
    public class ThSprinklerBeamExtractor : ThExtractorBase, IPrint, ITransformer
    {
        ...
        private const string DistanceToFloorPropertyName = "BottomDistanceToFloor";
        private List<ThStoreyInfo> StoreyInfos { get; set; }
        public List<ThRawIfcBuildingElementData> Db3ExtractResults { get; set; }
        public ThMEPOriginTransformer Transformer { get => transformer; set => transformer = value; }

        public ThSprinklerBeamExtractor()
        {
        ...
        public override void Extract(Database database, Point3dCollection pts)
        {
            ...
            {
                localBeams[i].Outline = ThSprinklerCleanEntityService.Buffer(localBeams[i].Outline as Polyline, 25);
            }
