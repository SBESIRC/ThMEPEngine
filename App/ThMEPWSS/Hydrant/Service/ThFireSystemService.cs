...
{
      public class ThFireSystemService
        {
            private readonly int FloorNumber;
            private readonly int PartNumber;
            private readonly int HouseholdNums;
            private readonly int[] CleaningTools;
            public ThFireSystemService(int floorNumber, int partNumber, int householdNums, int[] cleaningTools)
            {
