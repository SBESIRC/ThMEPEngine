...
{
    public static class NormalLowerMiddleCase
        {
            public static void Init(ThHalfFireBranchPipe halfBranchPipe)
            {
                ...
                if (halfBranchPipe.Households[halfBranchPipe.AreaIndex] != 0)
                {
                    ...
                    pt11 = new Point3d(pt7.X, halfBranchPipe.IndexStartY + halfBranchPipe.FloorNumber * halfBranchPipe.FloorHeight + 790, 0);
