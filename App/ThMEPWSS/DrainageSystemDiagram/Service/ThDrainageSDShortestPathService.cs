...
namespace ThMEPWSS.DrainageSystemDiagram
{
    class ThDrainageSDShortestPathService
    {
            ...
            foreach (var toilet in room.toilet)
            {
                toilet.SupplyCoolOnWall.ForEach(ptOnWall =>
                {
                    ...
                    else
                    {
                        ...
                        var ptOnWallIsland = findPtOnWall(wallList, toilet, tolCloseWallForIsland, true);
        ...
        private static List<Point3d> findPtOnWall(List<Line> wallList, ThTerminalToilet terminal, int TolClosedWall, bool toiletFaceSide)
        {
