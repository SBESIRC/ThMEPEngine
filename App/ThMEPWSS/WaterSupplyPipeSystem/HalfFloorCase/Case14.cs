    ...
    public static class Case14
    {
        public static void Init(HalfBranchPipe halfBranchPipe)
        {
            ...
            if (halfBranchPipe.Households[halfBranchPipe.AreaIndex] != 0)
            {
                ...
                var pt1502 = pt1501.OffsetX(461);
                var pt1503 = new Point3d(pt1502.X, halfBranchPipe.IndexStartY + (halfBranchPipe.FloorNumber - 1) * halfBranchPipe.FloorHeight+(halfBranchPipe.Households[halfBranchPipe.AreaIndex]-1)*250+100, 0);
                var pt1504 = pt1503.OffsetX(275);
                ...
                for (int i = 1; i < halfBranchPipe.Households[halfBranchPipe.AreaIndex]; i++)
                {
                    ...
                    var pt1602 = pt1502.OffsetXY(-200*i,-250 * i);
                    var pt1603 = pt1503.OffsetXY(-200 * i, -250 * i);
                    var pt1604 = pt1504.OffsetY(-250*i);
            ...
            if (halfBranchPipe.HasFlushFaucet) //有冲洗龙头
            {
                ...
                var pt21 = pt20.OffsetY(500);
                var pt211 = pt21.OffsetXY(155, 91);
                var pt212 = pt21.OffsetX(155);
                var pt213 = pt21.OffsetXY(155, -300);
                ...
                halfBranchPipe.BranchPipes.Add(new Line(pt202, pt20));
        ...
        public static void InitUpFloor(HalfBranchPipe halfBranchPipe, bool upperFloor)
        {
            ...
            if (upperFloor)
            {
                var pt1Y = curFloorLowerHeight + 517.5;
                ...
                halfBranchPipe.AutoExhaustValveSite = pt1.OffsetY(700);
                ...
                if (halfBranchPipe.Households[halfBranchPipe.AreaIndex] != 0)
                {
                    pt7 = pt374.OffsetX(217.5);
                    pt11 = new Point3d(pt7.X, halfBranchPipe.IndexStartY + (halfBranchPipe.FloorNumber - 0.5) * halfBranchPipe.FloorHeight - 130, 0);
                    var pt15 = pt11.OffsetX(510);


                    var pt1501 = pt15.OffsetXY(995, 995);
                    var pt1502 = pt1501.OffsetX(475);
                    var pt1503 = new Point3d(pt1502.X, curFloorLowerHeight + 340, 0);
                    var pt1504 = pt1503.OffsetX(275);
                    halfBranchPipe.BranchPipes.Add(new Line(pt11, pt15));
                    halfBranchPipe.BranchPipes.Add(new Line(pt15, pt1501));
                    halfBranchPipe.BranchPipes.Add(new Line(pt1501, pt1502));
            ...
            {
                var pt1Y = curFloorUpperHeight + 517.5;
                ...
                halfBranchPipe.AutoExhaustValveSite = pt1.OffsetY(750);
