...
namespace NFox.Cad
{
    ...
    public static class CurveEx
    {
        ...
        public static Curve3d ToCurve3d(this Curve curve)
        {
            if (curve is Line)
            {
                return ToCurve3d((Line)curve);
            }
            else if (curve is Circle)
            {
                return ToCurve3d((Circle)curve);
            }
            else if (curve is Arc)
            {
                return ToCurve3d((Arc)curve);
            }
            else if (curve is Ellipse)
            {
                return ToCurve3d((Ellipse)curve);
            }
            else if (curve is Polyline)
            {
                return ToCurve3d((Polyline)curve);
            }
            else if (curve is Polyline2d)
            {
                return ToCurve3d((Polyline2d)curve);
            }
            else if (curve is Polyline3d)
            {
                return ToCurve3d((Polyline3d)curve);
            }
            else if (curve is Spline)
            {
                return ToCurve3d((Spline)curve);
            }
        ...
        public static CompositeCurve3d ToCompositeCurve3d(this Curve curve)
        {
            if (curve is Line)
            {
                return new CompositeCurve3d(
                    new Curve3d[] { ToCurve3d((Line)curve) });
            }
            else if (curve is Circle)
            {
                return new CompositeCurve3d(
                    new Curve3d[] { ToCurve3d((Circle)curve) });
            }
            else if (curve is Arc)
            {
                return new CompositeCurve3d(
                    new Curve3d[] { ToCurve3d((Arc)curve) });
            }
            else if (curve is Ellipse)
            {
                return new CompositeCurve3d(
                    new Curve3d[] { ToCurve3d((Ellipse)curve) });
            }
            else if (curve is Polyline)
            {
                return ToCurve3d((Polyline)curve);
            ...
            {
                Polyline2d pl2d = (Polyline2d)curve;
                switch (pl2d.PolyType)
                {
                    case Poly2dType.SimplePoly:
                        return new CompositeCurve3d(
                            new Curve3d[] { ToPolylineCurve3d(pl2d) });
                    ...
                    default:
                        return new CompositeCurve3d(
                            new Curve3d[] { ToNurbCurve3d(pl2d) });
                }
            }
            else if (curve is Polyline3d)
            {
                Polyline3d pl3d = (Polyline3d)curve;
                switch (pl3d.PolyType)
                {
                    case Poly3dType.SimplePoly:
                        return new CompositeCurve3d(
                            new Curve3d[] { ToPolylineCurve3d(pl3d) });

                    default:
                        return new CompositeCurve3d(
                            new Curve3d[] { ToNurbCurve3d(pl3d) });
                }
            }
            else if (curve is Spline)
            {
                return
                    new CompositeCurve3d(
                        new Curve3d[] { ToCurve3d((Spline)curve) });
            }
        ...
        public static NurbCurve3d ToNurbCurve3d(this Curve curve)
        {
            if (curve is Line)
            {
                return ToNurbCurve3d((Line)curve);
            }
            else if (curve is Circle)
            {
                return ToNurbCurve3d((Circle)curve);
            }
            else if (curve is Arc)
            {
                return ToNurbCurve3d((Arc)curve);
            }
            else if (curve is Ellipse)
            {
                return ToNurbCurve3d((Ellipse)curve);
            }
            else if (curve is Polyline)
            {
                return ToNurbCurve3d((Polyline)curve);
            }
            else if (curve is Polyline2d)
            {
                return ToNurbCurve3d((Polyline2d)curve);
            }
            else if (curve is Polyline3d)
            {
                return ToNurbCurve3d((Polyline3d)curve);
            }
            else if (curve is Spline)
            {
                return ToCurve3d((Spline)curve);
        ...
        public static Curve3d ToCurve3d(this Polyline3d pl3d)
        {
            ...
            {
                case Poly3dType.SimplePoly:
                    return ToPolylineCurve3d(pl3d);

                default:
                    return ToNurbCurve3d(pl3d);
            }
        }
