...
{
    public partial class ParkingPartitionTestV2
    {
        [CommandMethod("TIANHUACAD", "ThParkPartitionTestV2", CommandFlags.Modal)]
        public void ThParkPartitionTestV2()
        {
            Execute();
        }
        ...
        public void Execute()
        {
            ...
            PartitionV2 partition = new PartitionV2(walls, iniLanes, obstacles, GeoUtilities.JoinCurves(walls, iniLanes)[0]);
