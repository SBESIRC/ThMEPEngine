...
namespace ThMEPElectrical.GroundingGrid.Data
{
    ...
    /// 接地引下线
    /// </summary>
    public class ThEarthConductorExtractor : ThExtractorBase,IGroup,IPrint
    {
        ...
        public ThEarthConductorExtractor()
        {
        ...
        public override List<ThGeometry> BuildGeometries()
        {
            ...
            FromUpToHereConductors.ForEach(o =>
            {
                ...
                geometry.Properties.Add(ThExtractorPropertyNameManager.NamePropertyName, "接地引下线");
        ...
        public override void Extract(Database database, Point3dCollection pts)
        {
            ...
            {
                BlockName = "E-BGND32", // 接地，E-GND32，从上至此
            };
            ...
            {
                BlockName = "E-BGND31", // 接地，E-GND31，从此往下
            };
