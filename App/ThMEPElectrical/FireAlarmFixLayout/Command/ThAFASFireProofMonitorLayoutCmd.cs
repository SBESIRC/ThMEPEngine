...
namespace ThMEPElectrical.FireAlarmFixLayout.Command
{
    class ThAFASFireProofMonitorLayoutCmd : ThMEPBaseCommand, IDisposable
    {
        ...
        public ThAFASFireProofMonitorLayoutCmd()
        {
            InitialCmdInfo();
            InitialSetting();
        }
        ...
        private void FireAlarmFireProofMonitorLayoutExecute()
        {
            ...
            using (AcadDatabase acadDatabase = AcadDatabase.Active())
            {
                ...
                var cleanBlkName = ThFaCommon.LayoutBlkList[6];
                ...
                //------------布置
                ThFireProofMonitorFixedPointLayoutService layoutService = null;
                layoutService = new ThFireProofMonitorFixedPointLayoutService(dataQuery);
