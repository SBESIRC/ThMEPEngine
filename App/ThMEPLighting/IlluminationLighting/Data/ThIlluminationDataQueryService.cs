...
{
    public class ThIlluminationDataQueryService
    {
        //input
        ...
        //public Dictionary<Polyline, ThIlluminationCommon.layoutType> FrameLightType { get; private set; } = new Dictionary<Polyline, ThIlluminationCommon.layoutType>();
        
        public Dictionary<ThGeometry, Polyline> roomFrameDict { get; set; } = new Dictionary<ThGeometry, Polyline>();
        public ThIlluminationDataQueryService(List<ThGeometry> data, List<string> cleanBlkName, List<string> avoidBlkNameList)
        {
            Data = data;
