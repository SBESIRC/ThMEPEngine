...
{
    public class ToCurveMapHelper : MapHelper
    {
        ...
        public override Point SetStartAndEndInfo(Point3d _startPt, EndModel endInfo)
        {
            ...
            endInfo.mapEndLine = new AStarLine( new Point(valueLst[2], valueLst[4]), new Point(valueLst[3], valueLst[4]));
