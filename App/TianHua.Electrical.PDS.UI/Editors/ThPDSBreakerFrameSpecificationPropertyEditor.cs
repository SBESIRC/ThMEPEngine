...
{
    public class ThPDSBreakerFrameSpecificationPropertyEditor : PropertyEditorBase
    {
        ...
        private List<string> GetItemsSource(PropertyItem propertyItem)
        {
            ...
            if (model != null)
            {
                return model.AlternativeFrameSpecifications;
            }
            else
            {
                return new List<string> { model.FrameSpecifications };
            }
        }
    }
}
