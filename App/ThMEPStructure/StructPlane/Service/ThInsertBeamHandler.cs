...
namespace ThMEPStructure.StructPlane.Service
{
    internal class ThInsertBeamHandler
    {
        ...
        public ThInsertBeamHandler(List<ThGeometry> beamGeos)
        {
            BeamGeos = beamGeos;
    ...
    internal class ThInsertBeamInfoGrouper
    {
        ...
        private InsertBeamInfo GetBranchSides(Line main, Line branch1, Line branch2)
        {
            ...
            if (branch1Side == null || branch2Side == null)
            {
                return null;
            }
        ...
        private Line FindCloseParallelLine(Line main, Line branch)
        {
            ...
            var objs = Query(outline).OfType<Line>()
                .Where(o => o.IsParallelToEx(main))
                .Where(o => IsBeamIntervalValid(o.ParallelDistanceTo(main)))
                .Where(o => IsPortOnLine(o, branch))
                .ToCollection();
