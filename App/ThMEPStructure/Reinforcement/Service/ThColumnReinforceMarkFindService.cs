...
{
    internal class ThColumnReinforceMarkFindService
    {
        ...
        public ThColumnReinforceMarkFindService(Dictionary<string, DBObjectCollection> markLines,
        ...
        public ColumnReinforceExtractInfo Find(Polyline outline)
        {
            if(outline ==null || !outline.IsRectangle())
            {
                return null;
            }
        ...
        private Point3dCollection Sort(Point3dCollection vertexes)
        {
