    ...
    internal class ThReinforceTestData
    {
        ...
        private List<ThEdgeComponent> CreateStdTestDatas()
        {
            ...
            var ltype6 = new ThLTypeEdgeComponent()
            {
                ...
                Stirrup = "C8@105",
                Reinforce = "6C16+6C14",
                EnhancedReinforce = "4C18+2C16+6C14",
                AntiSeismicGrade = "二级",
                Type = "A",
                IsCalculation = true,
                LinkWallPos = "1",
            ...
            var ltype7 = new ThLTypeEdgeComponent()
            {
                ...
                Stirrup = "C8@105",
                Reinforce = "6C16+6C14",
                EnhancedReinforce = "2C18+4C16+6C14",
                AntiSeismicGrade = "二级",
                Type = "B",
                IsCalculation = true,
                LinkWallPos = "1",
            ...
            var ttype15 = new ThTTypeEdgeComponent()
            {
                ...
                Stirrup = "C8@110",
                Reinforce = "6C16+10C14",
                EnhancedReinforce = "4C18+2C16+10C14",
                AntiSeismicGrade = "二级",
                Type = "A",
                IsCalculation = true,
                LinkWallPos = "1",
            ...
            var ttype16 = new ThTTypeEdgeComponent()
            {
                ...
                Stirrup = "C8@110",
                Reinforce = "6C16+10C14",
                EnhancedReinforce = "2C18+4C16+10C14",
                AntiSeismicGrade = "二级",
                Type = "B",
                IsCalculation = true,
                LinkWallPos = "2",
