...
namespace ThMEPHVAC.LoadCalculation.Model
{
    ...
    public class MainUIData
    {
        ...
        public bool chk_ColdW { get; set; } = true; //UI-CheckBox-冷水量
        public bool chk_ColdWP { get; set; } = true; //UI-CheckBox-冷水管径
        public int chk_ColdWP_Index { get; set; } //UI-CheckBox-冷水管径参数
        public bool chk_CondensateWP { get; set; } = true; //UI-CheckBox-冷凝水管径
        public bool chk_HotL { get; set; } = true; //UI-CheckBox-热负荷
        public bool chk_HotW { get; set; } = true;//UI-CheckBox-热水量
        public bool chk_HotWP { get; set; } = true;//UI-CheckBox-热水管径
        ...
        public bool chk_NormalAirVolume { get; set; } = true;//UI-CheckBox-平时排风量
        public bool chk_NormalFumeSupplementary { get; set; } = true;//UI-CheckBox-平时补风量
    }
}
