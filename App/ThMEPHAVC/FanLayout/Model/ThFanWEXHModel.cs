...
namespace ThMEPHVAC.FanLayout.Model
{
    ...
    public class ThFanWEXHModel
    {
        ...
        public void InsertWEXHFan(AcadDatabase acadDatabase)
        {
            ...
            var blkId = acadDatabase.ModelSpace.ObjectId.InsertBlockReference("H-EQUP-FANS", "AI-壁式排风扇", FanPosition, new Scale3d(1, 1, 1), 0, attNameValues);
