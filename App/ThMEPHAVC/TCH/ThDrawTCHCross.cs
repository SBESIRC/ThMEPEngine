...
namespace ThMEPHVAC.TCH
{
    public class ThDrawTCHCross
    {
        ...
        public ThDrawTCHCross(ThSQLiteHelper sqliteHelper)
        {
        ...
        public void Draw(EntityModifyParam info, Matrix3d mat, ref ulong gId)
        {
            ...
            var param1 = new TCHInterfaceParam()
            {
                ...
                sectionType = 0,
                height = 0,
                width = crossInfo.iWidth,
                normalVector = v,
                heighVector = new Vector3d(0, 0, 1),
                centerPoint = mainBigP - v * gap
            };
            ...
            var param2 = new TCHInterfaceParam()
            {
                ...
                sectionType = 0,
                height = 0,
                width = crossInfo.coWidth,
                normalVector = v,
                heighVector = new Vector3d(0, 0, 1),
                centerPoint = mainSmallP - v * gap
            };
            ...
            var param3 = new TCHInterfaceParam()
            {
                ...
                sectionType = 0,
                height = 0,
                width = crossInfo.innerWidth,
                normalVector = v,
                heighVector = new Vector3d(0, 0, 1),
                centerPoint = sideInnerP - v * gap
            };
            ...
            var param4 = new TCHInterfaceParam()
            {
                ...
                sectionType = 0,
                height = 0,
                width = crossInfo.outterWidth,
                normalVector = v,
                heighVector = new Vector3d(0, 0, 1),
                centerPoint = sideOutterP - v * gap
            };
            flangesService.Draw(mainBigP, param1.normalVector, crossInfo.iWidth, ref gId);
            flangesService.Draw(mainSmallP, param2.normalVector, crossInfo.coWidth, ref gId);
            flangesService.Draw(sideInnerP, param3.normalVector, crossInfo.innerWidth, ref gId);
            flangesService.Draw(sideOutterP, param3.normalVector, crossInfo.outterWidth, ref gId);
