...
namespace ThMEPHVAC.Model
{
    public class ThDuctPortsReDrawFactory
    {
        ...
        {
            var modify_width = ThDuctPortsService.Get_width(modify_size);
            ...
            return Create_reducing(line, reducing.port_widths[0], reducing.port_widths[1]);
        }
        public static Line_Info Create_reducing(Point2d sp, Point2d ep, double big_width, double small_width)
        {
            ...
            return Create_reducing(l, big_width, small_width);
        }
        public static Line_Info Create_reducing(Line l, double big_width, double small_width)
        {
            var geo = ThDuctPortsFactory.Create_reducing_geo(l, big_width, small_width);
        ...
        public static Line_Info Create_tee(Entity_modify_param tee, int port_idx, double modify_width)
        {
            ...
            var type = ThDuctPortsService.Is_collinear(branch_vec, main_small_vec) ?
